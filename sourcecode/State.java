...
abstract class State {
    ...
    // constructor for the abstract class used by the state classes
    ...
    public void insert_cups(int n) {System.out.println("Inser_Cups not on this state");} // of cups
    public void coin(int f){System.out.println("Coin() not on this state");}
